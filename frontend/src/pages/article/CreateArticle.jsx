...
function CreateArticle() {
  ...
  const handleImageChange = (e) => {
    ...
    reader.onloadend = () => {
      ...
      showSuccess('Gambar dipilih', 'Siap dipublish');
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await showSuccess('Success!', 'Artikel berhasil dibuat');
      navigate('/');
    } catch (err) {
      const message = err.response?.data?.message || 'Gagal membuat artikel';
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <h1 className="text-4xl font-bold mb-8 text-center">Buat Artikel Baru</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div>
          ...
          {!imagePreview ? (
            ...
            >
              <p className="text-gray-600">Klik untuk pilih gambar</p>
